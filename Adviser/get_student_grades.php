...
foreach ($candidates as $table) {
    try {
        ...
        if ($row) {
            ...
            $finalComputed = round((($q1?:0)+($q2?:0)+($q3?:0)+($q4?:0))/4, 2);
            ...
            $results[] = ['table'=>$table,'subject'=>$subject,'q1'=>$q1,'q2'=>$q2,'q3'=>$q3,'q4'=>$q4,'final_stored'=>$finalStored,'final_computed'=>$finalComputed];
        }
...
send(['success'=>true,'grades'=>$results,'debug'=>$debug ? $debugLogs : []]);
